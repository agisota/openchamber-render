...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install Rox Space for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'Rox Space installed',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to Rox Space — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'header.services.shutdownDev': 'Stop Rox Space',
  ...
  'aboutDialog.openChamberVersionLabel': 'Rox Space version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Rox Space state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate Rox Space efficiently',
  ...
  'header.actions.openAppMenu': 'Rox Space menu',
  'header.actions.openAppMenuAria': 'Open Rox Space menu',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock Rox Space',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote Rox Space servers',
  ...
  'multiRun.window.description': 'Rox Space Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to Rox Space',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If Rox Space does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of Rox Space — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to Rox Space settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an Rox Space server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an Rox Space server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different Rox Space version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running Rox Space but is not compatible with this app version. Update Rox Space on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Rox Space. Verify the address points to an Rox Space server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running Rox Space. Verify the address points to an Rox Space server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The Rox Space server at "{host}" is not compatible with this app version. Update Rox Space on the server, then try again.',
  ...
  'startup.initRecovery.description': 'Rox Space could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating Rox Space...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep Rox Space open.',
  ...
  'openChamberLogo.aria.logo': 'Rox Space logo',
