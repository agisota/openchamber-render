...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj Rox Space, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'Rox Space został zainstalowany',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia Rox Space.',
  ...
  'onboarding.chooser.title': 'Witaj w Rox Space',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli Rox Space nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień Rox Space i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera Rox Space aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer Rox Space, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji Rox Space. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia Rox Space, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj Rox Space na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim Rox Space. Zweryfikuj czy adres wskazuje na serwer Rox Space.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia Rox Space. Zweryfikuj czy adres wskazuje na serwer Rox Space.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer Rox Space pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj Rox Space na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'Rox Space nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan Rox Space, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja Rox Space {version}',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do Rox Space — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami Rox Space',
  ...
  'header.actions.openAppMenu': 'Menu Rox Space',
  'header.actions.openAppMenuAria': 'Otwórz menu Rox Space',
  ...
  'header.services.shutdownDev': 'Zatrzymaj Rox Space',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po Rox Space.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj Rox Space',
  ...
  'updateDialog.header.updating': 'Aktualizowanie Rox Space...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw Rox Space otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce Rox Space — zainstaluj je, aby zacząć.',
