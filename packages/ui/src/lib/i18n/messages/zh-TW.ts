...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 Rox Space 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'Rox Space 已安裝',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 Rox Space。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 Rox Space，但與此應用程式版本不相容。請更新伺服器上的 Rox Space 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 Rox Space 伺服器與此應用程式版本不相容。請更新伺服器上的 Rox Space 後重試。',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 Rox Space 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Rox Space 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 Rox Space',
  ...
  'header.actions.openAppMenu': 'Rox Space 選單',
  'header.actions.openAppMenuAria': '開啟 Rox Space 選單',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 Rox Space',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 Rox Space 伺服器之間切換',
  ...
  'multiRun.window.description': 'Rox Space 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 Rox Space',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Rox Space 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 Rox Space 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 Rox Space 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 Rox Space 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 Rox Space 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 Rox Space。請確認位址是否指向 Rox Space 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 Rox Space。請確認位址是否指向 Rox Space 伺服器。',
  ...
  'startup.initRecovery.description': 'Rox Space 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 Rox Space 開啟。',
  ...
  'openChamberLogo.aria.logo': 'Rox Space 標誌',
