...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 Rox Space 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'Rox Space 已安装',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '关于 Rox Space',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 Rox Space 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'header.services.shutdownDev': '停止 Rox Space',
  ...
  'aboutDialog.openChamberVersionLabel': 'Rox Space 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Rox Space 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 Rox Space',
  ...
  'header.actions.openAppMenu': 'Rox Space 菜单',
  'header.actions.openAppMenuAria': '打开 Rox Space 菜单',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 Rox Space',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 Rox Space 服务器之间切换',
  ...
  'multiRun.window.description': 'Rox Space 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 Rox Space',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Rox Space 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 Rox Space 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 Rox Space 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 Rox Space 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 Rox Space 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 Rox Space。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 Rox Space，但与此应用版本不兼容。请更新服务器上的 Rox Space 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 Rox Space。请确认地址是否指向 Rox Space 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 Rox Space。请确认地址是否指向 Rox Space 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 Rox Space 服务器与此应用版本不兼容。请更新服务器上的 Rox Space 后重试。',
  ...
  'startup.initRecovery.description': 'Rox Space 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.header.updating': '正在更新 Rox Space...',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 Rox Space 打开。',
  ...
  'openChamberLogo.aria.logo': 'Rox Space 标志',
