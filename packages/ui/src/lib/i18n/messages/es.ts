...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala Rox Space para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "Rox Space se instaló",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a Rox Space: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "header.services.shutdownDev": "Detener Rox Space",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de Rox Space {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de Rox Space, el estado de OpenCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por Rox Space de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de Rox Space",
  "header.actions.openAppMenuAria": "Abrir menú de Rox Space",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de Rox Space",
  ...
  "multiRun.window.description": "Ventana de Rox Space Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a Rox Space",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si Rox Space no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de Rox Space. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de Rox Space y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de Rox Space para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor Rox Space o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de Rox Space. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta Rox Space pero no es compatible con esta versión de la app. Actualiza Rox Space en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando Rox Space. Verifica que la dirección apunte a un servidor Rox Space.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando Rox Space. Verifica que la dirección apunte a un servidor Rox Space.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor Rox Space en \"{host}\" no es compatible con esta versión de la app. Actualiza Rox Space en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "Rox Space no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando Rox Space...",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén Rox Space abierto.",
  ...
  "openChamberLogo.aria.logo": "Logo de Rox Space",
