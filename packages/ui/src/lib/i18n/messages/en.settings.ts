export const settingsDict = {
  ...
  'settings.window.description': 'Rox Space settings window.',
  ...
  'settings.remoteInstances.direct.title': 'Other Rox Space servers',
  'settings.remoteInstances.direct.description': 'Add another Rox Space server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another Rox Space server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid Rox Space connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so Rox Space Desktop can connect to this server.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether Rox Space should start the server for you, or connect to one that is already running.',
  ...
  'settings.openchamber.about.title': 'About Rox Space',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. Rox Space will scan it for folders containing',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start Rox Space at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start Rox Space when you log in',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Rox Space asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open Rox Space there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Rox Space on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how Rox Space should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote Rox Space server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote Rox Space UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How Rox Space should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing Rox Space',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating Rox Space',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by Rox Space.',
  ...
  'settings.github.page.flow.title': 'Authorize Rox Space',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if Rox Space auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from Rox Space.',
