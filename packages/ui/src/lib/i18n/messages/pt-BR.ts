...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "pwa.installPrompt.description": "Instale o Rox Space para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "Rox Space instalado",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Sobre o Rox Space",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao Rox Space — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "header.services.shutdownDev": "Parar Rox Space",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do Rox Space {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do Rox Space, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo Rox Space com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do Rox Space",
  "header.actions.openAppMenuAria": "Abrir menu do Rox Space",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear Rox Space",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do Rox Space",
  ...
  "multiRun.window.description": "Janela do Rox Space Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao Rox Space",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o Rox Space não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do Rox Space. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do Rox Space e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do Rox Space para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor Rox Space ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do Rox Space. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando Rox Space, mas não é compatível com esta versão do app. Atualize o Rox Space no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando Rox Space. Verifique se o endereço aponta para um servidor Rox Space.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando Rox Space. Verifique se o endereço aponta para um servidor Rox Space.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor Rox Space em \"{host}\" não é compatível com esta versão do app. Atualize o Rox Space no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O Rox Space não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando Rox Space...",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o Rox Space aberto.",
  ...
  "openChamberLogo.aria.logo": "Logo do Rox Space",
