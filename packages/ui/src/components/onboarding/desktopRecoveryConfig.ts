  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running Rox Space. Verify the address points to a Rox Space server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The Rox Space server at "${host || 'unknown'}" is not compatible with this app version. Update Rox Space on the server, then try again.`,
