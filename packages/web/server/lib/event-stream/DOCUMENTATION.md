...
## Purpose
This module contains the Rox Space message-stream WebSocket protocol and runtime bridge. It keeps the browser-facing WebSocket transport separate from the upstream OpenCode SSE transport.
...
- Rox Space still fetches OpenCode upstream event streams over SSE.
