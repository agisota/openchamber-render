---
title: Themes
description: Customize Rox Space with built-in and user-defined themes.
---

# Themes

Rox Space supports built-in themes and custom theme JSON files.
...
3. Open Rox Space, then go to **Settings -> Theme -> Reload themes**.
