---
title: Temas
description: Personalize o Rox Space com temas integrados e definidos pelo usuário.
---

# Temas

O Rox Space oferece suporte a temas integrados e arquivos JSON de tema personalizados.
...
3. Abra o Rox Space e vá em **Settings -> Theme -> Reload themes**.
