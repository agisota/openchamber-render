---
title: Reverse Proxy
description: Configure Rox Space correctly behind Nginx, Nginx Proxy Manager, or another reverse proxy.
---

# Reverse Proxy

Use this page if you run Rox Space behind Nginx, Nginx Proxy Manager, Caddy, Cloudflare, or another reverse proxy.
