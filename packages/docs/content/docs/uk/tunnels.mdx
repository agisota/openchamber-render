---
title: Тунелі
description: Безпечно відкрийте Rox Space для віддаленого та мобільного доступу.
---

# Тунелі

Тунель — це публічне посилання на ваш Rox Space, щоб дістатися до нього з телефона чи з іншої мережі. Скористайтеся `openchamber tunnel`, щоб створити його для запущеного інстансу.

## Передумови

Rox Space запускає CLI провайдера тунелю на вашій машині. Спочатку встановіть провайдера, який хочете використовувати:
...
Коли тунель піднято, `status` показує публічний URL. Відкрийте його або відскануйте QR-код, щоб дістатися до Rox Space звідусіль.

Типово Rox Space виводить QR-код в інтерактивних TTY-сесіях. Використовуйте `--qr`, щоб примусово вивести QR, або `--no-qr`, щоб вимкнути його.
...
- один активний тунель на інстанс Rox Space (порт)
...
- [PWA та мобільний доступ](/uk/mobile/) — відкривайте Rox Space з телефона
