---
title: Temas
description: Personaliza Rox Space con temas integrados y definidos por el usuario.
---

# Temas

Rox Space admite temas integrados y archivos JSON de tema personalizados.
...
3. Abre Rox Space y ve a **Settings -> Theme -> Reload themes**.
