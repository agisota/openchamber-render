---
title: Quickstart
description: Start Rox Space quickly and pick the right app for the task.
---
...
2. Install the Rox Space CLI (see [Install](/install/) for the one-line command).
...
You should see the Rox Space session list in your browser. If it loads, you're up and running.
